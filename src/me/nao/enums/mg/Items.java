...
@SuppressWarnings("deprecation")
        public enum Items{
            ...
            MASCARAANTIGAS(""+ChatColor.GREEN+ChatColor.BOLD+"MASCARA ANTIGAS", Material.CREEPER_HEAD,null, 1, ChatColor.GREEN+"Te vuelve inmune al Gas Toxico.", ChatColor.GREEN+"Debes colcocarlo en tu Cabeza.", ChatColor.GOLD+"Durabilidad:"+ ChatColor.GREEN+" 30"+ChatColor.RED+"/"+ChatColor.GREEN+"30",ChatColor.RED+"Se Rompera poco a poco si te golpean.", ChatColor.GREEN+"Precio: "+ChatColor.RED+"64 de Hierro"),
            MASCARAANTIGASP(""+ChatColor.GREEN+ChatColor.BOLD+"MASCARA ANTIGAS", Material.CREEPER_HEAD,null, 1, ChatColor.GREEN+"Te vuelve inmune al Gas Toxico.", ChatColor.GREEN+"Debes colcocarlo en tu Cabeza.", ChatColor.GOLD+"Durabilidad:"+ ChatColor.GREEN+" 30"+ChatColor.RED+"/"+ChatColor.GREEN+"30",ChatColor.RED+"Se Rompera poco a poco si te golpean."),
            ...
            TNTARROW2(""+ChatColor.GREEN+ChatColor.BOLD+"TNT ARROW 2", Material.TNT,"fire_aspect,3/knockback,3", 1,ChatColor.RED+ "Lanza la TNT que Explota con Muchas Flechas."),
            TNTARROW3(""+ChatColor.GREEN+ChatColor.BOLD+"TNT ARROW 3", Material.TNT,"fire_aspect,3/knockback,3", 1,ChatColor.RED+ "Lanza la TNT que Explota con Muchas Flechas."),
